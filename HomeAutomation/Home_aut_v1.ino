...
void loop() 
{
 ...
 if (gsmdata[1] == 'A')
   ...
   if(ctr%2!=0)
      ...
      if(ctr%2==0)//LEDs turn off when ctr is even
      {
        lcd.clear();
   ...
   //LEDs blink on and off when ctr is odd
     ...
     if(ctr2%2==0)//LEDs turn off when ctr is even
      {
   ...
   if(ctr3%2!=0)
      ...
      if(ctr3%2==0)//LEDs turn off when ctr is even
      {
        lcd.clear();
   ...
   if(ctr4%2!=0)
      ...
      if(ctr4%2==0)//LEDs turn off when ctr is even
      {
        lcd.clear();
